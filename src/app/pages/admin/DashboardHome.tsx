...
import { Wrench, Images, MessageSquareQuote, HelpCircle, ImageIcon, BarChart3, ShieldCheck, Footprints, Tag, Plus } from "lucide-react";
...
export default function DashboardHome() {
  ...
  const actions = [
    ...
    { label: "Edit Keunggulan", icon: ShieldCheck, to: "/admin/keunggulan" },
